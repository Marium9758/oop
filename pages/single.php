        ...
        <main class="post blog-post col-lg-8"> 
          <div class="container">
            <div class="post-single">
              <div class="post-thumbnail"><img src="assets/public/img/blog-post-3.jpeg" alt="..." class="img-fluid"></div>
              <div class="post-details">
                ...
                <div class="post-body">
                  ...
                  <p> <img src="assets/public/img/featured-pic-3.jpeg" alt="..." class="img-fluid"></p>
                  ...
                  <div class="comment">
                    <div class="comment-header d-flex justify-content-between">
                      <div class="user d-flex align-items-center">
                        <div class="image"><img src="assets/public/img/user.svg" alt="..." class="img-fluid rounded-circle"></div>
